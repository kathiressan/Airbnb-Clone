...
export default function Home({ exploreData, cardsData, discoverData }) {
  const getDarkMode = useSelector(selectMode);
  return (
    <div
      className={`${
        getDarkMode
    ...
    >
      ...
      <main className="max-w-7xl mx-auto px-8 sm:px-16">
        <section className="pt-6">
          <h2 className="text-4xl font-semibold pb-5 dark:text-white darkModeTransition">
            Explore Nearby
          </h2>
        ...
        <section>
          <h2 className="text-4xl font-semibold py-8 dark:text-white darkModeTransition">
            Live Anywhere
          </h2>
